...
const defaultSettings: SiteSettings = {
  ...
  blogDescription: 'Stay informed with the latest academic updates',
  notesHeading: 'Study Notes',
  notesDescription: 'Download notes shared by our faculty',
  eventsHeading: 'Events',
  eventsDescription: 'Stay updated with upcoming college events',
